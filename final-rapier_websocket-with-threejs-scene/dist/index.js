...
function createPeerConnection(theirSocketId, isInitiator) {
  console.log('Creating peer connection with:', theirSocketId);
  ...
  peerConnection.on('stream', (stream) => {
    ...
    audioElement.controls = true; // Add audio controls
    audioElement.volume = 1.0; // Set initial volume
...
// Create microphone status element
